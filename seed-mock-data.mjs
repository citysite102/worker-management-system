...
const workersData = [
  { nameEn: "SUPARMAN", nameCn: "蘇巴曼", name: "蘇巴曼 SUPARMAN", birthDate: "1990-03-12", gender: "male",
    nationality: "104 印尼", birthPlace: "印尼", occupation: "manufacturing",
  ...
  { nameEn: "NGUYEN VAN AN", nameCn: null, name: "NGUYEN VAN AN", birthDate: "1992-07-22", gender: "male",
    nationality: "105 越南", birthPlace: "越南", occupation: "manufacturing",
    lifecycleStatus: "document_processing", documentStatus: "pending_supplement",
  ...
  { nameEn: "WAYAN SUDANA", nameCn: null, name: "WAYAN SUDANA", birthDate: "1988-11-03", gender: "male",
    nationality: "104 印尼", birthPlace: "印尼", occupation: "manufacturing",
    lifecycleStatus: "recruiting", documentStatus: "not_started",
  ...
  { nameEn: "MARIA SANTOS", nameCn: null, name: "MARIA SANTOS", birthDate: "1995-05-18", gender: "female",
    nationality: "102 菲律賓", birthPlace: "菲律賓", occupation: "manufacturing",
    lifecycleStatus: "employed", documentStatus: "complete",
  ...
  { nameEn: "DELA CRUZ JOSE", nameCn: null, name: "DELA CRUZ JOSE", birthDate: "1993-09-09", gender: "male",
    nationality: "102 菲律賓", birthPlace: "菲律賓", occupation: "manufacturing",
    lifecycleStatus: "document_processing", documentStatus: "expiring_soon",
    residentPermitNo: "AD30912348", residentPermitExpiry: "2025-08-15",
  ...
  { nameEn: "TRAN THI HOA", nameCn: null, name: "TRAN THI HOA", birthDate: "1991-02-14", gender: "female",
    nationality: "105 越南", birthPlace: "越南", occupation: "other",
    lifecycleStatus: "employed", documentStatus: "complete",
  ...
  { nameEn: "SOMCHAI PROMMA", nameCn: null, name: "SOMCHAI PROMMA", birthDate: "1994-08-30", gender: "male",
    nationality: "103 泰國", birthPlace: "泰國", occupation: "agriculture",
    lifecycleStatus: "document_processing", documentStatus: "pending_supplement",
    residentPermitNo: "AD30912351", residentPermitExpiry: "2027-04-30",
  ...
  { nameEn: "BUDI SANTOSO", nameCn: null, name: "BUDI SANTOSO", birthDate: "1996-01-20", gender: "male",
    nationality: "104 印尼", birthPlace: "印尼", occupation: "agriculture",
    lifecycleStatus: "recruiting", documentStatus: "not_started",
    residentPermitNo: null, residentPermitExpiry: null,
  ...
  { nameEn: "SITI RAHAYU", nameCn: null, name: "SITI RAHAYU", birthDate: "1990-10-05", gender: "female",
    nationality: "104 印尼", birthPlace: "印尼", occupation: "caregiver_family",
    lifecycleStatus: "employed", documentStatus: "complete",
  ...
  { nameEn: "AUNG MYAT", nameCn: null, name: "AUNG MYAT", birthDate: "1993-04-17", gender: "male",
    nationality: "107 緬甸", birthPlace: "緬甸", occupation: "fishery",
    lifecycleStatus: "pending_renewal", documentStatus: "expiring_soon",
    residentPermitNo: "AD30912353", residentPermitExpiry: "2025-07-31",
  ...
  { nameEn: "DEWI LESTARI", nameCn: null, name: "DEWI LESTARI", birthDate: "1997-06-28", gender: "female",
    nationality: "104 印尼", birthPlace: "印尼", occupation: "caregiver_hospital",
    lifecycleStatus: "departed", documentStatus: "complete",
...
for (let i = 0; i < workersData.length; i++) {
  ...
  const [r] = await conn.execute(
    `INSERT INTO workers
      (nameEn, nameCn, name, birthDate, gender, nationality, birthPlace, occupation,
     ...
     VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), NOW())`,
    [w.nameEn, w.nameCn, w.name, w.birthDate, w.gender, w.nationality, w.birthPlace, w.occupation,
